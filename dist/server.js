...
const RootQuery=new graphql__WEBPACK_IMPORTED_MODULE_0__["GraphQLObjectType"]({name:'RootQueryType',fields:{user: _queries_User__WEBPACK_IMPORTED_MODULE_1__["user"],users: _queries_User__WEBPACK_IMPORTED_MODULE_1__["users"]}});const Mutation=new graphql__WEBPACK_IMPORTED_MODULE_0__["GraphQLObjectType"]({name:'Mutation',fields:{addUser: _mutations_User__WEBPACK_IMPORTED_MODULE_2__["addUser"],updateUser: _mutations_User__WEBPACK_IMPORTED_MODULE_2__["updateUser"],deleteUser: _mutations_User__WEBPACK_IMPORTED_MODULE_2__["deleteUser"],deleteManyUser: _mutations_User__WEBPACK_IMPORTED_MODULE_2__["deleteManyUser"],validateUser: _mutations_User__WEBPACK_IMPORTED_MODULE_2__["validateUser"]}});/* harmony default export */ __webpack_exports__["default"] = (new graphql__WEBPACK_IMPORTED_MODULE_0__["GraphQLSchema"]({query:RootQuery,mutation:Mutation}));
...
/*!***************************************!*\
  !*** ./src/graphql/mutations/User.js ***!
  \***************************************/
/*! exports provided: addUser, validateUser, updateUser, deleteUser, deleteManyUser */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
const localesEn={validate:{blank:'Can not be blank',invalid:'is Invalid',taken:'is already taken. ',confirmPass:'Confirm Password is not correct',authenticate:'Your Email or Password is not correct'},message:{success:{delete:'Delete Successfully',connect:'Connection Successfully',authenticate:'Authenticate Successfully'},failure:{connect:'Connection Error'}}};
