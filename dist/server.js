...
/*!***********************************!*\
  !*** ./src/db/constant/regexp.js ***!
  \***********************************/
/*! exports provided: nameRegExp, emailRegExp, passRegExp, phoneRegExp */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "passRegExp", function() { return passRegExp; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "phoneRegExp", function() { return phoneRegExp; });
const nameRegExp=/^[a-zA-Z0-9]+$/;const emailRegExp=/\S+@\S+\.\S+/;const passRegExp=/^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)(?=.*[@$!%*?&])[A-Za-z\d@$!%*?&]{8,}$/;const phoneRegExp=/^\d{10}$/;
...
function asyncGeneratorStep(gen,resolve,reject,_next,_throw,key,arg){try{var info=gen[key](arg);var value=info.value;}catch(error){reject(error);return;}if(info.done){resolve(value);}else{Promise.resolve(value).then(_next,_throw);}}function _asyncToGenerator(fn){return function(){var self=this,args=arguments;return new Promise(function(resolve,reject){var gen=fn.apply(self,args);function _next(value){asyncGeneratorStep(gen,resolve,reject,_next,_throw,"next",value);}function _throw(err){asyncGeneratorStep(gen,resolve,reject,_next,_throw,"throw",err);}_next(undefined);});};}const UserSchema=new mongoose__WEBPACK_IMPORTED_MODULE_0___default.a.Schema({username:{type:String,lowercase:true,required:[true,Object(_config_i18n__WEBPACK_IMPORTED_MODULE_5__["i18n"])('validate.blank')],match:[_constant_regexp__WEBPACK_IMPORTED_MODULE_4__["nameRegExp"],Object(_config_i18n__WEBPACK_IMPORTED_MODULE_5__["i18n"])('validate.invalid')],index:true},email:{type:String,lowercase:true,required:[true,Object(_config_i18n__WEBPACK_IMPORTED_MODULE_5__["i18n"])('validate.blank')],match:[_constant_regexp__WEBPACK_IMPORTED_MODULE_4__["emailRegExp"],Object(_config_i18n__WEBPACK_IMPORTED_MODULE_5__["i18n"])('validate.invalid')]},bio:String,image:String,gender:{type:String,enum:[Object(_config_i18n__WEBPACK_IMPORTED_MODULE_5__["i18n"])('enum.user.gender.male'),Object(_config_i18n__WEBPACK_IMPORTED_MODULE_5__["i18n"])('enum.user.gender.female')]},phone:{type:String,required:false,match:[_constant_regexp__WEBPACK_IMPORTED_MODULE_4__["phoneRegExp"],Object(_config_i18n__WEBPACK_IMPORTED_MODULE_5__["i18n"])('validate.invalid')]},birthDay:{type:Date,default:null},hash:String,salt:String},{timestamps:true});UserSchema.plugin(mongoose_unique_validator__WEBPACK_IMPORTED_MODULE_1___default.a,{message:Object(_config_i18n__WEBPACK_IMPORTED_MODULE_5__["i18n"])('validate.taken')});const encryPassword=function encryPassword(password,salt){return crypto__WEBPACK_IMPORTED_MODULE_2___default.a.pbkdf2Sync(password,salt,10000,512,'sha512').toString('hex');};UserSchema.methods.setPassword=function(password){this.salt=crypto__WEBPACK_IMPORTED_MODULE_2___default.a.randomBytes(16).toString('hex');this.hash=encryPassword(password,this.salt);};UserSchema.methods.generateJWT=function(){const today=new Date();const exp=new Date(today);exp.setDate(today.getDate()+60);return jsonwebtoken__WEBPACK_IMPORTED_MODULE_3___default.a.sign({id:this._id,username:this.username,email:this.email,bio:this.bio,image:this.image,exp:parseInt(exp.getTime()/1000,10)},process.env.SECERET_JWT);};UserSchema.methods.toAuthJSON=function(){return{token:this.generateJWT()};};UserSchema.statics.authenticate=function(){var _ref=_asyncToGenerator(function*(email,password){const user=yield this.findOne({email});const hash=encryPassword(password,user.salt);if(user.hash===hash)return user.toAuthJSON();return{error:Object(_config_i18n__WEBPACK_IMPORTED_MODULE_5__["i18n"])('validate.authenticate')};});return function(_x,_x2){return _ref.apply(this,arguments);};}();UserSchema.statics.updateUserInfo=function(){var _ref2=_asyncToGenerator(function*(id,type,data){const user=yield this.findById(id);user[type]=data[type];user.save();return user.toAuthJSON();});return function(_x3,_x4,_x5){return _ref2.apply(this,arguments);};}();const User=mongoose__WEBPACK_IMPORTED_MODULE_0___default.a.model('User',UserSchema);
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! ./../../../node_modules/process/browser.js */ "./node_modules/process/browser.js")))
...
const localesEn={validate:{blank:'Can not be blank',invalid:'is Invalid',taken:'is already taken. ',passwordValidate:'Your Password is not right format',confirmPass:'Confirm Password is not correct',authenticate:'Your Email or Password is not correct'},message:{success:{delete:'Delete Successfully',connect:'Connection Successfully',authenticate:'Authenticate Successfully',addUser:'User Sign Up Successfully'},failure:{connect:'Connection Error'}},enum:{user:{gender:{male:'Male',female:'Female'}}}};
